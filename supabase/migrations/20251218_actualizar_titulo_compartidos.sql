-- ============================================
-- UPDATE: Cambiar título de documentos compartidos
-- De "Compartido" a "Requisitos para Desembolso"
-- ============================================
...
SELECT DISTINCT ON (clientes_con_fuentes.cliente_id, rfc.id)
  ...
  rfc.descripcion,
  rfc.alcance,
  'Requisitos para Desembolso' as tipo_fuente,  -- ✅ NUEVO: Título claro
  NULL as entidad,
  NULL::NUMERIC as monto_aprobado,
  jsonb_build_object(
    'tipo_fuente', 'Requisitos para Desembolso',  -- ✅ NUEVO
