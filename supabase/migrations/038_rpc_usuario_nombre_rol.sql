-- =====================================================
-- MIGRACIÓN 038: RPC guarda nombre+rol en lugar de UUID
-- =====================================================
-- usuario_registro ahora es TEXT (migración 036)
-- Resolvemos nombre+rol desde la tabla usuarios antes de insertar
-- Parámetro p_usuario_id se mantiene como UUID para la sesión,
-- pero se convierte a "Nombres Apellidos (Rol)" antes de guardar.
-- =====================================================
...
BEGIN
  ...
  -- Fallback si el usuario no está en la tabla
