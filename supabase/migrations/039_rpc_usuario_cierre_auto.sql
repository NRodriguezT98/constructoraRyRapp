-- =====================================================
-- MIGRACIÓN 039: Llenar usuario_cierre en cierre automático
-- =====================================================
-- El trigger calcular_monto_devolver cierra la renuncia
-- automáticamente (estado='Cerrada', fecha_cierre=NOW())
-- cuando monto_a_devolver = 0, pero no puede conocer
-- el usuario. El RPC ahora hace un UPDATE post-INSERT
-- para asignar usuario_cierre = usuario_registro en ese caso.
-- =====================================================
...
BEGIN
  ...
  -- Si el trigger cerró la renuncia (monto_a_devolver = 0),
  -- la misma persona que registró también la cerró.
  -- ═══════════════════════════════════════
  UPDATE renuncias
