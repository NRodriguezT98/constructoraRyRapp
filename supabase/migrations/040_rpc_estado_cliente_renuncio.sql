-- =====================================================
-- MIGRACIÓN 040: Actualizar estado del cliente a 'Renunció'
-- =====================================================
-- BUG CRÍTICO: El RPC cascadeaba negociación, vivienda y
-- fuentes de pago, pero NUNCA actualizaba clientes.estado.
-- El cliente quedaba como 'Activo' después de renunciar.
--
-- FIX: Agregar UPDATE clientes SET estado = 'Renunció'
-- + Backfill de clientes con renuncias existentes.
-- =====================================================
...
BEGIN
  ...
  -- ═══════════════════════════════════════
  -- ✅ NUEVO: CASCADA: Actualizar estado del cliente
  -- ═══════════════════════════════════════
  UPDATE clientes
  SET estado = 'Renunció',
      fecha_actualizacion = NOW()
...
-- ═══════════════════════════════════════
-- BACKFILL: Clientes con renuncias existentes
-- que siguen mostrando estado 'Activo'
-- ═══════════════════════════════════════
UPDATE clientes
SET estado = 'Renunció',
    fecha_actualizacion = NOW()
