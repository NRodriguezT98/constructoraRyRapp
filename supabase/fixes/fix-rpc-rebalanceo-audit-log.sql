-- ============================================================
-- FIX: rebalancear_plan_financiero - audit_log insert missing
-- usuario_email (NOT NULL), usuario_rol, usuario_nombres
--
-- Root cause: The INSERT into audit_log only sends tabla, accion,
-- registro_id, datos_anteriores, datos_nuevos, metadata, modulo,
-- usuario_id — but audit_log.usuario_email is NOT NULL.
-- ============================================================
