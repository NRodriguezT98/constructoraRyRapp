...
Esta carpeta contiene scripts SQL de utilidades para análisis y generación de documentación.

## 📋 Archivos

- **generar-doc-markdown.sql** - Genera documentación de la base de datos en formato Markdown
...
- `/docs/database` - Documentación de base de datos
