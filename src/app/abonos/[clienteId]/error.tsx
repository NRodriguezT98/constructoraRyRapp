...
export default function Error({
  ...
  useEffect(() => {
    errorLog('ERROR EN DETALLE DE ABONO', error, { digest: error.digest })
  }, [error])
      ...
      <div className='w-full max-w-md rounded-2xl border border-gray-200 bg-white p-8 shadow-xl dark:border-gray-700 dark:bg-gray-800'>
        <div className='flex flex-col items-center text-center'>
          ...
          <h1 className='mb-2 text-2xl font-bold text-gray-900 dark:text-white'>
            Error al cargar abonos del cliente
          </h1>

          <p className='mb-6 text-sm text-gray-600 dark:text-gray-400'>
            {error.message ||
              'Ocurrió un error inesperado al cargar el detalle de abonos'}
          </p>
          ...
          <div className='flex w-full gap-3'>
            ...
            <button
              onClick={reset}
              className='flex flex-1 items-center justify-center gap-2 rounded-lg bg-violet-600 px-4 py-2.5 font-medium text-white transition-colors hover:bg-violet-700'
            >
