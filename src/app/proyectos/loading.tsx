    ...
    <div className='flex h-screen w-full items-center justify-center bg-gradient-to-br from-gray-50 via-green-50/30 to-emerald-50/30 dark:from-gray-900 dark:via-green-950/20 dark:to-emerald-950/20'>
      <div className='flex flex-col items-center gap-8'>
        ...
        <div className='relative'>
          {/* Outer Rotating Ring */}
          <motion.div
            className='absolute inset-0 h-32 w-32 rounded-full border-4 border-transparent border-r-emerald-500 border-t-green-500'
            animate={{ rotate: 360 }}
            transition={{
              duration: 2,
              repeat: Infinity,
        ...
        >
          <motion.h2
            className='bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 bg-clip-text text-2xl font-bold text-transparent'
            animate={{
