...
export const headerClasses = {
  container:
    'relative overflow-hidden rounded-xl bg-gradient-to-br from-green-600 via-emerald-600 to-teal-600 dark:from-green-700 dark:via-emerald-700 dark:to-teal-800 p-4 shadow-2xl shadow-green-500/20',
...
export const progressClasses = {
  ...
  iconContainer:
    'rounded-lg bg-gradient-to-br from-green-500 to-emerald-600 p-1.5',
  ...
  barFill:
    'h-full bg-gradient-to-r from-green-500 via-emerald-500 to-teal-500 transition-all duration-1500',
  shimmer:
