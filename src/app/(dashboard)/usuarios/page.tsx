...
/**
 * ============================================
 * PÁGINA: Gestión de Usuarios (Premium Design)
 * ============================================
 *
 * Página principal del módulo de usuarios con:
...
export default function UsuariosPage() {
  ...
  useEffect(() => {
    if (!authLoading && (!perfil || perfil.rol !== 'Administrador')) {
  ...
  return (
    <div className="container mx-auto px-4 py-4 sm:px-4 lg:px-6">
      ...
      {/* 🎈 FAB SUPERIOR DERECHO (Solo admins pueden crear usuarios) */}
      <CanCreate modulo="usuarios">
        <motion.div
            ...
            <table className={styles.tabla.table}>
              <thead className={styles.tabla.thead}>
                <tr>
                  ...
                  <th className={styles.tabla.th}>Acciones</th>
                </tr>
              </thead>
