...
export default function UsuariosContent({
  ...
  const [usuarioEditar, setUsuarioEditar] = useState<UsuarioCompleto | null>(
    null
  )
      ...
      <UsuariosTabs>
        <div className='space-y-4'>
          ...
          <div className={styles.tabla.container}>
            {error && (
              <div className='m-4 rounded-lg border border-red-200 bg-red-50 p-4 text-sm text-red-800 dark:border-red-800 dark:bg-red-900/20 dark:text-red-300'>
                {error}
              </div>
            )}
