...
export const headerClasses = {
  ...
  subtitle: 'mt-2 flex items-center gap-2 text-white/90',
  subtitleIcon: 'h-4 w-4',
...
export const tabsClasses = {
  ...
  tab: 'relative flex-1 min-w-max cursor-pointer border-b-2 px-6 py-4 text-center transition-colors',
  ...
  tabIcon: 'h-4 w-4',
  tabBadge:
    'rounded-full bg-purple-100 px-2 py-0.5 text-xs font-bold text-purple-700 dark:bg-purple-900/30 dark:text-purple-300',
...
export const infoCardClasses = {
  card: 'rounded-xl border border-gray-200 bg-white p-6 shadow-sm hover:shadow-md transition-shadow dark:border-gray-800 dark:bg-gray-800/50',
  ...
  fieldContainer: 'flex items-start gap-3',
  fieldIconContainer:
    'flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-purple-100 dark:bg-purple-900/30',
  fieldIcon: 'h-5 w-5 text-purple-600 dark:text-purple-400',
  fieldContent: 'flex-1',
  fieldLabel: 'text-sm font-medium text-gray-500 dark:text-gray-400',
  fieldValue: 'mt-1 text-base font-semibold text-gray-900 dark:text-white',
  fieldValueEmpty: 'mt-1 text-base font-semibold text-gray-400 dark:text-gray-600 italic',
}
...
export const emptyStateClasses = {
  ...
  icon: 'mb-4 h-16 w-16 text-gray-400 dark:text-gray-600',
  title: 'mb-2 text-lg font-semibold text-gray-900 dark:text-gray-100',
  description: 'mb-6 text-sm text-gray-600 dark:text-gray-400',
  button:
...
export const warningStateClasses = {
  container:
    'rounded-xl border-2 border-amber-200 bg-amber-50 p-6 dark:border-amber-800/30 dark:bg-amber-900/10',
  header: 'mb-4 flex items-center gap-3',
  icon: 'h-6 w-6 text-amber-600 dark:text-amber-400',
  title: 'text-lg font-bold text-amber-900 dark:text-amber-100',
  description: 'mb-4 text-sm text-amber-800 dark:text-amber-200',
  list: 'mb-4 space-y-2',
  listItem: 'flex items-start gap-2 text-sm text-amber-800 dark:text-amber-200',
  listIcon: 'mt-0.5 text-amber-600 dark:text-amber-400',
  button:
    'inline-flex items-center gap-2 rounded-lg bg-amber-600 px-4 py-2 text-sm font-medium text-white hover:bg-amber-700',
}
