...
export default function Error({
  ...
  useEffect(() => {
    errorLog('ERROR EN DETALLE DE CLIENTE', error, { digest: error.digest })
  }, [error])
      ...
      <div className='w-full max-w-md rounded-2xl border border-gray-200 bg-white p-8 shadow-xl dark:border-gray-700 dark:bg-gray-800'>
        <div className='flex flex-col items-center text-center'>
          ...
          <p className='mb-6 text-sm text-gray-600 dark:text-gray-400'>
            {error.message ||
              'Ocurrió un error inesperado al cargar el detalle del cliente'}
          </p>
          ...
          <div className='flex w-full gap-3'>
            ...
            <button
              onClick={reset}
              className='flex flex-1 items-center justify-center gap-2 rounded-lg bg-cyan-600 px-4 py-2.5 font-medium text-white transition-colors hover:bg-cyan-700'
            >
