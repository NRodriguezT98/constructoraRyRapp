 ...
 */
export const TIPOS_DOCUMENTO_ARRAY: TipoDocumentoInfo[] =
  Object.values(TIPOS_DOCUMENTO)

/**
 * Obtener información de un tipo de documento
 */
export function obtenerInfoTipoDocumento(
  tipo: TipoDocumentoValidacion | null | undefined
): TipoDocumentoInfo | null {
  if (!tipo) return null
 ...
 */
export function esTipoDocumentoValido(
  tipo: string
): tipo is TipoDocumentoValidacion {
