...
export class DocumentosService {
  ...
  static obtenerDocumentosPorEntidad =
    DocumentosBaseService.obtenerDocumentosPorEntidad

  // ⚠️ LEGACY (mantener compatibilidad)
  static obtenerDocumentosPorProyecto =
    DocumentosBaseService.obtenerDocumentosPorProyecto
  static obtenerDocumentosPorCategoria =
    DocumentosBaseService.obtenerDocumentosPorCategoria
  ...
  static obtenerDocumentosImportantes =
    DocumentosBaseService.obtenerDocumentosImportantes
  ...
  static contarVersionesActivas =
    DocumentosVersionesService.contarVersionesActivas
  static obtenerVersionesEliminadas =
    DocumentosVersionesService.obtenerVersionesEliminadas
  ...
  static marcarVersionComoErronea =
    DocumentosEstadosService.marcarVersionComoErronea
  static marcarVersionComoObsoleta =
    DocumentosEstadosService.marcarVersionComoObsoleta
  static restaurarEstadoVersion =
    DocumentosEstadosService.restaurarEstadoVersion
  ...
  static async archivarDocumento(
    ...
    return DocumentosEliminacionService.archivarDocumento(
      documentoId,
      tipoEntidad
    )
  }
  ...
  static async restaurarDocumento(
    ...
    return DocumentosEliminacionService.restaurarDocumentoArchivado(
      documentoId,
      tipoEntidad
    )
  }
  ...
  static async obtenerDocumentosArchivados(
    ...
    return DocumentosEliminacionService.obtenerDocumentosArchivados(
      entidadId,
      tipoEntidad
    )
  }
  ...
  static async eliminarDocumento(
    ...
    return DocumentosEliminacionService.eliminarDocumento(
      documentoId,
      tipoEntidad
    )
  }
  ...
  static async restaurarDocumentoEliminado(
    ...
    return DocumentosEliminacionService.restaurarDocumentoEliminado(
      documentoId,
      tipoEntidad
    )
  }
  ...
  static async eliminarDefinitivo(
    ...
    return DocumentosEliminacionService.eliminarDefinitivo(
      documentoId,
      tipoEntidad
    )
  }
