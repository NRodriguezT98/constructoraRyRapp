...
export const pageStyles = {
  ...
  container:
    'min-h-screen bg-gradient-to-br from-gray-50 via-cyan-50/30 to-blue-50/30 dark:from-gray-950 dark:via-cyan-950/20 dark:to-blue-950/20',
  ...
  header: {
    ...
    // Breadcrumbs
    breadcrumbs:
      'flex items-center gap-2 mb-4 text-xs text-cyan-100 dark:text-cyan-200',
  ...
  breadcrumbs: {
    container:
      'flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400 mb-4',
  ...
  stepper: {
    container:
      'backdrop-blur-xl bg-white/90 dark:bg-gray-800/90 rounded-xl border border-gray-200/50 dark:border-gray-700 p-3 shadow-2xl shadow-cyan-500/10',
  ...
  card: {
    ...
    section: 'space-y-3',
    sectionTitle:
      'text-sm font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-2',
  ...
  sidebar: {
    ...
    title:
      'text-xs font-bold text-cyan-900 dark:text-cyan-100 mb-3 flex items-center gap-2 uppercase tracking-wider',
    titleIcon: 'w-4 h-4',
    value:
      'text-2xl font-bold bg-gradient-to-r from-cyan-600 via-blue-600 to-indigo-600 bg-clip-text text-transparent',
  ...
  input: {
    ...
    success:
      'w-full px-3 py-2 bg-white dark:bg-gray-900 border-2 border-green-500 dark:border-green-500 ring-2 ring-green-500/20 rounded-lg text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none transition-all text-sm',
    error:
      'w-full px-3 py-2 bg-white dark:bg-gray-900 border-2 border-red-500 dark:border-red-500 ring-2 ring-red-500/20 rounded-lg text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none transition-all text-sm',
    readonly:
      'w-full px-3 py-2 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-lg text-sm font-semibold text-gray-600 dark:text-gray-300 cursor-not-allowed',
  },
  ...
  navigation: {
    ...
    backButton:
      'inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 text-sm font-semibold hover:bg-gray-200 dark:hover:bg-gray-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed',
    backIcon: 'w-4 h-4',

    nextButton:
      'inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-br from-cyan-500 to-blue-500 text-white text-sm font-semibold hover:from-cyan-600 hover:to-blue-600 transition-all shadow-lg shadow-cyan-500/30 hover:shadow-xl hover:shadow-cyan-500/40 disabled:opacity-50 disabled:cursor-not-allowed',
    nextIcon: 'w-4 h-4',

    submitButton:
      'inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-br from-green-500 to-emerald-500 text-white text-sm font-semibold hover:from-green-600 hover:to-emerald-600 transition-all shadow-lg shadow-green-500/30 hover:shadow-xl hover:shadow-green-500/40',
    submitIcon: 'w-4 h-4',
  ...
  button: {
    primary:
      'inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-br from-cyan-500 to-blue-500 text-white text-sm font-semibold hover:from-cyan-600 hover:to-blue-600 transition-all shadow-lg shadow-cyan-500/30',
    secondary:
      'inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 text-sm font-semibold hover:bg-gray-200 dark:hover:bg-gray-600 transition-all',
    success:
      'inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-br from-green-500 to-emerald-500 text-white text-sm font-semibold hover:from-green-600 hover:to-emerald-600 transition-all shadow-lg shadow-green-500/30',
    danger:
      'inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-br from-red-500 to-rose-500 text-white text-sm font-semibold hover:from-red-600 hover:to-rose-600 transition-all shadow-lg shadow-red-500/30',
  },

  footer: {
    container:
      'flex items-center justify-between pt-4 mt-6 border-t-2 border-gray-200 dark:border-gray-700',
  ...
  progress: {
    ...
    label:
      'flex items-center justify-between text-xs font-semibold text-gray-700 dark:text-gray-300',
  ...
  alert: {
    ...
    success:
      'backdrop-blur-xl bg-green-50/90 dark:bg-green-950/80 border-2 border-green-200 dark:border-green-700 rounded-lg p-3 flex items-start gap-2.5 shadow-lg',
    warning:
      'backdrop-blur-xl bg-yellow-50/90 dark:bg-yellow-950/80 border-2 border-yellow-200 dark:border-yellow-700 rounded-lg p-3 flex items-start gap-2.5 shadow-lg',
    error:
      'backdrop-blur-xl bg-red-50/90 dark:bg-red-950/80 border-2 border-red-200 dark:border-red-700 rounded-lg p-3 flex items-start gap-2.5 shadow-lg',
