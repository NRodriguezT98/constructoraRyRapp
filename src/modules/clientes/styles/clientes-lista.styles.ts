...
export const clientesListaStyles = {
  ...
  // 🔍 FILTROS (COMPACTOS)
  filtros: {
    container: 'sticky top-4 z-40 backdrop-blur-xl bg-white/90 dark:bg-gray-800/90 rounded-xl border border-gray-200/50 dark:border-gray-700/50 p-4 shadow-2xl shadow-cyan-500/10',
    ...
    searchInput: 'w-full pl-10 pr-10 py-2.5 bg-gray-50 dark:bg-gray-900/50 border-2 border-gray-200 dark:border-gray-700 rounded-lg focus:border-cyan-500 focus:ring-4 focus:ring-cyan-500/20 transition-all text-sm placeholder:text-gray-400 dark:placeholder:text-gray-500',
    ...
    select: 'w-full pl-10 pr-10 py-2.5 bg-gray-50 dark:bg-gray-900/50 border-2 border-gray-200 dark:border-gray-700 rounded-lg focus:border-cyan-500 focus:ring-4 focus:ring-cyan-500/20 transition-all text-sm appearance-none cursor-pointer',
    selectIconRight: 'absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 dark:text-gray-500 pointer-events-none',

    // Footer (compacto)
    footer: 'flex items-center justify-between pt-3 mt-3 border-t border-gray-200 dark:border-gray-700',
