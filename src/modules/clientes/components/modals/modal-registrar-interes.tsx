...
export function ModalRegistrarInteres({
  ...
  const handleComboboxSelect = (vivienda: (typeof viviendas)[number]) => {
    ...
    const manzLabel = vivienda.manzanas?.nombre
              ...
              <div className='flex-1 space-y-6 overflow-y-auto px-8 py-6'>
                  ...
                  {errorNegociacionExistente && (
                    ...
                    >
                      ...
                      <div className={sharedAlertStyles.content}>
                        ...
                        <p
                          className={
                            sharedAlertStyles.message +
                            ' text-red-600 dark:text-red-400'
                          }
                        >
                          Este cliente ya tiene un interés activo en la vivienda
                          seleccionada.
                        </p>
                      </div>
                    </motion.div>
                ...
                <div>
                  <label className='mb-1.5 flex items-center gap-1.5 text-sm font-medium text-gray-700 dark:text-gray-300'>
                    ...
                    Vivienda <span className='ml-0.5 text-red-500'>*</span>
                  </label>
                  ...
                  <input
                    type='hidden'
                    {...register('viviendaId', {
                      required: 'Debes seleccionar una vivienda',
                    })}
                  />
                  ...
                  <div ref={comboboxRef} className='relative'>
                    <div className='relative'>
                      ...
                      <input
                        ...
                        className={`w-full rounded-xl border-2 bg-white py-2.5 pl-9 pr-9 text-sm text-gray-900 transition-all placeholder:text-gray-400 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 dark:bg-gray-900 dark:text-gray-100 ${
                          errors.viviendaId
                            ? 'border-red-300 focus:border-red-500 focus:ring-2 focus:ring-red-500/20 dark:border-red-700'
                            : viviendaIdSeleccionada
                              ? 'border-blue-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 dark:border-blue-600'
                              : 'border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 dark:border-gray-700'
                        }`}
                      />
                    ...
                    {comboboxOpen &&
                      proyectoIdSeleccionado &&
                      !cargandoViviendas && (
                        <div className='absolute z-50 mt-1 max-h-52 w-full overflow-y-auto rounded-xl border border-gray-200 bg-white shadow-2xl dark:border-gray-700 dark:bg-gray-800'>
                          {viviendasFiltradas.length === 0 ? (
                            ...
                            viviendasFiltradas.map(vivienda => (
                              <button
                                ...
                                className={`flex w-full items-center justify-between border-b border-gray-50 px-4 py-2.5 text-left text-sm transition-colors last:border-0 dark:border-gray-700/50 ${
                              ...
                              >
                                ...
                                <span className='ml-3 flex-shrink-0 text-xs text-gray-500 dark:text-gray-400'>
                                  $
                                  {(vivienda.valor_total ?? 0).toLocaleString(
                                    'es-CO'
                                  )}
                                </span>
                              </button>
                  ...
                  {errors.viviendaId && (
                    <p className='mt-1 text-xs text-red-500'>
                      {String(errors.viviendaId.message)}
                    </p>
                  )}
                </div>
                ...
                <ModernSelect
                  ...
                  required
                  {...register('origen', {
                    required: 'Selecciona el origen del interés',
                  })}
                  disabled={guardando}
