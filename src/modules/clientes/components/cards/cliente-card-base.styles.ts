...
export const clienteCardBaseStyles = {
  ...
  container:
    'group relative overflow-hidden rounded-2xl backdrop-blur-xl bg-white/80 dark:bg-gray-800/80 border border-gray-200/50 dark:border-gray-700/50 shadow-lg hover:shadow-2xl transition-all duration-300',
  ...
  header: {
    ...
    actionButton:
      'p-1 rounded-lg text-gray-600 dark:text-gray-400 hover:bg-cyan-100 dark:hover:bg-cyan-900/30 hover:text-cyan-600 dark:hover:text-cyan-400 transition-all',
    actionButtonDelete:
      'p-1 rounded-lg text-gray-600 dark:text-gray-400 hover:bg-red-100 dark:hover:bg-red-900/30 hover:text-red-600 dark:hover:text-red-400 transition-all',
    ...
    documento:
      'text-xs text-gray-500 dark:text-gray-400 flex items-center gap-1 mt-0.5',
    ...
    badge:
      'inline-flex items-center gap-1 px-2 py-0.5 rounded-lg text-white text-xs font-bold shadow-md',
  ...
  section: {
    ...
    title:
      'flex items-center gap-1.5 mb-2 text-xs font-bold uppercase tracking-wider',
  ...
  footer: {
    container:
      'flex items-center justify-between gap-2 pt-2 border-t border-gray-200 dark:border-gray-700',
...
export const badgeSecondaryStyles = {
  success:
    'inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold border bg-emerald-50 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300 border-emerald-300 dark:border-emerald-700',
  warning:
    'inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold border bg-orange-50 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300 border-orange-300 dark:border-orange-700',
