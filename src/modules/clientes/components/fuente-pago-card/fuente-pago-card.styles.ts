...
export const fuentePagoCardStyles = {
  ...
  container: {
    ...
    disabled:
      'rounded-xl border-2 transition-all border-gray-200 bg-gray-50 dark:border-gray-700 dark:bg-gray-800/50',
  },

  // Header
  header: {
    container:
      'flex items-center justify-between border-b-2 border-gray-200 p-3 dark:border-gray-700',
    iconWrapper: {
      enabled: (bgColor: string) =>
        `flex h-12 w-12 items-center justify-center rounded-xl ${bgColor}`,
      disabled:
        'flex h-12 w-12 items-center justify-center rounded-xl bg-gray-200 dark:bg-gray-700',
    },
    icon: {
    ...
    badgeObligatorio:
      'inline-flex items-center rounded-full bg-red-100 px-2 py-0.5 text-xs font-medium text-red-700 dark:bg-red-900/30 dark:text-red-300',
  },
  ...
  input: {
    label:
      'mb-1.5 flex items-center gap-2 text-sm font-medium text-gray-700 dark:text-gray-300',
    labelRequired: 'text-red-500',
    field:
      'mt-1 block w-full rounded-lg border-gray-300 bg-white px-4 py-2 text-gray-900 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100 disabled:text-gray-500 dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:focus:border-blue-400 dark:focus:ring-blue-400',
  ...
  upload: {
    container:
      'rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 p-4 dark:border-gray-600 dark:bg-gray-800/50',
    ...
    removeButton:
      'rounded-lg bg-red-100 p-2 text-red-600 hover:bg-red-200 dark:bg-red-900/30 dark:hover:bg-red-900/50',
