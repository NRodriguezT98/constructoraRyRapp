...
export const PASOS_PROYECTO: WizardStepConfig[] = [
  {
    ...
    description:
      'Define el nombre, departamento, ciudad, dirección y una descripción del proyecto de construcción.',
    icon: Building2,
  },
  {
    id: 2,
    ...
    description:
      'Selecciona el estado actual del proyecto y las fechas de inicio y fin estimada.',
    icon: CalendarDays,
  },
  {
    id: 3,
    title: 'Manzanas',
    description:
      'Configura la distribución de manzanas y la cantidad de viviendas por cada una.',
    icon: LayoutGrid,
  },
]
