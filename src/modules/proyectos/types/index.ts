...
export type EstadoProyecto = 'en_planificacion' | 'en_construccion' | 'completado' | 'pausado'

export type EstadoManzana = 'planificada' | 'en_construccion' | 'completada'

export type TipoDocumento = 'plano' | 'permiso' | 'contrato' | 'factura' | 'otro'
...
export interface ProyectosActions {
    ...
    actualizarProyecto: (id: string, data: Partial<ProyectoFormData>) => Promise<Proyecto>
