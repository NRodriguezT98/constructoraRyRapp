...
export const proyectoCardStyles = {
    ...
    container: {
        ...
        lista: 'group relative bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-blue-400 dark:hover:border-blue-600 transition-all duration-300 hover:shadow-lg overflow-hidden'
    },
    ...
    header: {
        ...
        iconWrapper: 'flex-shrink-0 w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center shadow-lg',
        iconWrapperGrid: 'flex-shrink-0 w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center shadow-xl mb-4',
    ...
    text: {
        ...
        descriptionGrid: 'text-sm text-gray-600 dark:text-gray-400 line-clamp-3 mb-4',
        ubicacion: 'text-sm text-gray-500 dark:text-gray-400 flex items-center gap-1.5',
    ...
    stats: {
        ...
        itemGrid: 'flex items-center gap-2 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg',
        icon: 'w-4 h-4',
    ...
    badge: {
        ...
        estados: {
            planificacion: 'bg-blue-100 text-blue-800 dark:bg-blue-900/20 dark:text-blue-400',
            en_construccion: 'bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-400',
            pausado: 'bg-orange-100 text-orange-800 dark:bg-orange-900/20 dark:text-orange-400',
    ...
    button: {
        ...
        delete: 'hover:bg-red-50 dark:hover:bg-red-900/20 text-red-600 dark:text-red-400',
        deleteConfirm: 'hover:bg-red-600 dark:hover:bg-red-700 text-white bg-red-500',
        icon: 'w-4 h-4'
    },

    // Efectos y estados
    effects: {
        gradient: 'absolute inset-0 bg-gradient-to-br from-blue-500/5 to-purple-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300',
        border: 'absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-blue-500 to-purple-500 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300'
    },
