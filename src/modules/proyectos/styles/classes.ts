...
export const buttonStyles = {
  primary:
    'bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white shadow-lg hover:shadow-xl transition-all duration-300',
  secondary:
    'border-gray-200 dark:border-gray-700 hover:border-blue-500 dark:hover:border-blue-400 transition-colors',
  danger:
...
export const inputStyles = {
  ...
  search:
    'pl-10 bg-gray-50/50 dark:bg-gray-700/50 border-gray-200 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-400',
  large:
    'pl-12 h-12 text-lg bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 focus:border-blue-500 dark:focus:border-blue-400 transition-colors',
}
...
export const textStyles = {
  title:
    'text-4xl font-bold bg-gradient-to-r from-gray-900 to-gray-600 dark:from-white dark:to-gray-300 bg-clip-text text-transparent',
...
export const emptyStateStyles = {
  ...
  badge:
    'absolute -top-2 -right-2 p-2 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full',
  title: 'text-2xl font-bold text-gray-900 dark:text-white mb-3',
  description:
    'text-gray-600 dark:text-gray-300 mb-8 max-w-md mx-auto leading-relaxed',
}
...
export const gridStyles = {
  grid: (isGrid: boolean) =>
    `grid gap-6 ${isGrid ? 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3' : 'grid-cols-1'}`,
