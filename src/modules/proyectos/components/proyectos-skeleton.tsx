            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {skeletons.map((_, index) => (
                    <motion.div
                        ...
                        className="relative bg-white dark:bg-gray-800 rounded-2xl border border-gray-200/50 dark:border-gray-700/50 p-6 space-y-4 shadow-lg overflow-hidden"
                    >
                        {/* Resplandor decorativo animado */}
                        <motion.div
                            className="absolute -top-20 -right-20 w-40 h-40 bg-blue-500/5 dark:bg-blue-500/10 rounded-full blur-3xl"
                            animate={{
                                scale: [1, 1.3, 1],
                                opacity: [0.3, 0.5, 0.3],
                            }}
                        ...
                        <div className="flex gap-3">
                            <Skeleton variant="rectangular" width="50%" height={42} className="rounded-xl" />
                            <Skeleton variant="rectangular" width="50%" height={42} className="rounded-xl" />
                        </div>
                    </motion.div>
                ))}
        ...
        <div className="space-y-4">
            {skeletons.map((_, index) => (
                <motion.div
                    ...
                    className="relative bg-white dark:bg-gray-800 rounded-2xl border border-gray-200/50 dark:border-gray-700/50 p-6 shadow-lg overflow-hidden"
                >
                    ...
                    <div className="relative flex items-center gap-6">
                        ...
                        <div className="flex-1 space-y-4">
                            ...
                            <div className="flex gap-6 pt-2">
                                <Skeleton variant="rectangular" width={130} height={52} className="rounded-xl" />
                                <Skeleton variant="rectangular" width={130} height={52} className="rounded-xl" />
                                <Skeleton variant="rectangular" width={130} height={52} className="rounded-xl" />
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col gap-3 flex-shrink-0">
                            <Skeleton variant="rectangular" width={110} height={42} className="rounded-xl" />
                            <Skeleton variant="rectangular" width={110} height={42} className="rounded-xl" />
                        </div>
                    </div>
                </motion.div>
