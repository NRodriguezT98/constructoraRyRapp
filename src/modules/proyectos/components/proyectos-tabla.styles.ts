...
export const proyectosTablaStyles = {
  // Iconos y avatares
  iconContainer:
    'w-8 h-8 rounded-lg bg-gradient-to-br from-green-500 to-emerald-500 flex items-center justify-center shadow-md shadow-green-500/20',
  ...
  // Badges de manzanas
  manzanasBadge:
    'inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-800/50',
  ...
  progressBar: {
    ...
    track:
      'flex-1 h-1.5 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden relative',
    fillVendidas:
      'absolute top-0 left-0 h-full bg-gradient-to-r from-green-500 to-emerald-500 transition-all',
    fillAsignadas:
