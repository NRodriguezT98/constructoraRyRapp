...
export const negociacionCardStyles = {
  ...
  header: {
    wrapper:
      'bg-gradient-to-r from-orange-50 to-amber-50 dark:from-orange-900/20 dark:to-amber-900/20 px-4 py-3 border-b border-gray-200 dark:border-gray-700',
    clienteContainer: 'flex items-center justify-between',
    clienteInfo: 'flex items-center gap-3',
    iconWrapper:
      'w-10 h-10 rounded-full bg-gradient-to-r from-orange-500 to-amber-500 flex items-center justify-center',
  ...
  vivienda: {
    container:
      'grid grid-cols-2 gap-3 pb-3 border-b border-gray-200 dark:border-gray-700',
  ...
  fuentes: {
    ...
    progreso:
      'h-1.5 rounded-full bg-gray-200 dark:bg-gray-700 overflow-hidden mt-2',
  ...
  footer: {
    wrapper:
      'px-4 py-3 bg-gray-50 dark:bg-gray-900/50 border-t border-gray-200 dark:border-gray-700 flex justify-between items-center gap-2',
