...
export function AplicarMoraModal({
  cuota,
  moraSugerida,
  procesando,
  onConfirmar,
  onCerrar,
}: AplicarMoraModalProps) {
  const [moraStr, setMoraStr] = useState<string>(
    moraSugerida > 0 ? moraSugerida.toLocaleString('es-CO') : ''
  )
          ...
          <div className='space-y-4 p-5'>
              ...
              <div className='grid grid-cols-2 gap-3 text-sm'>
                ...
                <div>
                  ...
                  <p className='font-medium text-orange-600 dark:text-orange-400'>
                    {moraSugerida > 0
                      ? `$${moraSugerida.toLocaleString('es-CO')}`
                      : 'N/A'}
                  </p>
                </div>
              </div>
            ...
            <div>
              ...
              <p className='mt-1 text-xs text-gray-500 dark:text-gray-400'>
                Puedes ajustar el monto. El sugerido se calcula con la tasa de
                mora configurada en el crédito.
              </p>
            </div>
