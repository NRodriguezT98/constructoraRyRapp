/**
 * ============================================
 * COMPONENTE: FuentePagoCardRefactored
 * ============================================
 *
 * ✅ COMPONENTE REFACTORIZADO - ARQUITECTURA LIMPIA
 *
 * ANTES: 634 líneas de horror spaghetti 🍝
 * AHORA: < 100 líneas de código limpio ✨
 *
 ...
 * - Main: FuentePagoCardRefactored (orquestador)
 */
...
interface FuentePagoCardRefactoredProps {
...
export function FuentePagoCardRefactored({
  fuente,
  clienteId,
  onMarcarPaso,
  onVerDocumento,
}: FuentePagoCardRefactoredProps) {
