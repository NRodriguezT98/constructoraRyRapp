...
export const nuevaViviendaStyles = {
  ...
  // ==================== STEPPER HORIZONTAL ====================
  stepper: {
    container: 'backdrop-blur-xl bg-white/90 dark:bg-gray-800/90 rounded-xl border border-gray-200/50 dark:border-gray-700/50 p-3 shadow-2xl shadow-orange-500/10', // ← p-3 (más compacto), sin sticky
  ...
  navigation: {
    container: 'backdrop-blur-xl bg-white/90 dark:bg-gray-800/90 rounded-xl border border-gray-200/50 dark:border-gray-700/50 p-3 shadow-2xl shadow-orange-500/10', // ← p-3 (más compacto), sin sticky (se aplica inline)
