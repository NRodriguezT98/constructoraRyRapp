...
import { useCategoriasViviendaQuery, useSubirDocumentoViviendaMutation } from './useDocumentosViviendaQuery'
...
export function useDocumentoUpload({
  ...
  const { mutateAsync: subirDocumento, isPending: subiendoDocumento } = useSubirDocumentoViviendaMutation(viviendaId)
