/**
 * useDetectarCambiosDocumento - Hook para detectar y comparar cambios en documentos de viviendas
 *
 * ✅ Hook personalizado (SOLO lógica)
 * ✅ < 200 líneas
 * ✅ Funciones puras de comparación
 *
 * ADAPTADO DESDE: src/modules/documentos/hooks/useDetectarCambiosDocumento.ts
 */
...
export function useDetectarCambiosDocumento(
  documentoOriginal: DocumentoVivienda,
