// ============================================
// SERVICE: Documentos Vivienda - Gestión de Versiones
// ============================================
...
export class DocumentosVersionesService {
  ...
  static async crearNuevaVersion(
    ...
    const storagePath = `${docOriginal.vivienda_id}/${categoriaNombre}/${nombreArchivo}`
   ...
   */
  static async obtenerVersiones(documentoId: string): Promise<DocumentoVivienda[]> {
