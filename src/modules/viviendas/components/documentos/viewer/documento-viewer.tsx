...
import { DocumentoVivienda, formatFileSize, getFileIcon } from '@/modules/viviendas/types/documento-vivienda.types'
import { moduleThemes, type ModuleName } from '@/shared/config/module-themes'
import { CategoriaIcon } from '../shared/categoria-icon'

interface DocumentoViewerProps {
  documento: DocumentoVivienda | null
  isOpen: boolean
  onClose: () => void
  onDownload?: (documento: DocumentoVivienda) => void
  onDelete?: (documento: DocumentoVivienda) => void
  onEdit?: (documento: DocumentoVivienda) => void
  urlPreview?: string
  moduleName?: ModuleName //  Tema del mó³dulo
}
...
export function DocumentoViewer({
  ...
  onEdit,
  urlPreview,
  moduleName = 'viviendas', //  Default a proyectos
              ...
              <div className='flex flex-1 overflow-hidden'>
                ...
                <div className='w-80 space-y-6 overflow-y-auto border-l border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-900'>
                  ...
                  <div className='space-y-3'>
                    ...
                    {/* 1. Fecha de emisió³n/expedició³n del documento */}
                    <div className='flex items-start gap-2 text-sm'>
                      ...
                      <div className='flex-1'>
                        <p className='text-gray-600 dark:text-gray-400'>
                          Fecha de emisió³n del documento
                        </p>
                        ...
                        !isNaN(new Date(documento.fecha_documento).getTime()) ? (
                          ...
                          <p className='font-medium text-gray-600 dark:text-gray-400'>
                            Sin fecha de emisió³n
                          </p>
                        )}
                      </div>
                    </div>

                    {/* 2. Fecha de expiració³n */}
                    <div className='flex items-start gap-2 text-sm'>
                      <Clock
                        size={16}
