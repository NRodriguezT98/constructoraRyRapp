...
import { useDetectarCambiosDocumento, useDocumentoEditar } from '@/modules/viviendas/hooks/documentos'
import type { CategoriaDocumento, DocumentoVivienda } from '@/modules/viviendas/types/documento-vivienda.types'
...
export function DocumentoEditarMetadatosModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Mostrar modal de confirmaciÃ³n de cambios
  ...
  return (
    <>
      ...
      <AnimatePresence>
        ...
        >
          {/* Header verde del mÃ³dulo de proyectos */}
          <div className='sticky top-0 z-10 flex items-center justify-between bg-gradient-to-r from-orange-600 via-amber-600 to-yellow-600 px-6 py-4 rounded-t-2xl'>
              ...
              <div className="backdrop-blur-xl bg-white/80 dark:bg-gray-800/80 border border-gray-200/50 dark:border-gray-700/50 rounded-xl p-4 shadow-lg space-y-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    MÃ­nimo 3 caracteres, máximo 200
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    Categoriza el documento para mejor organizaciÃ³n
                  </p>
                </div>
            ...
            <div className='flex gap-3 pt-4 border-t border-gray-200 dark:border-gray-700'>
              ...
              <div className="flex-1 relative group">
                <button
                  ...
                  className='w-full rounded-lg bg-gradient-to-r from-orange-600 via-amber-600 to-yellow-600 px-4 py-2.5 text-sm font-semibold text-white transition-all hover:from-orange-700 hover:via-amber-700 hover:to-yellow-700 hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2'
                >
                  {editando ? (
                    <>
        ...
        {/* Modal de ConfirmaciÃ³n de Cambios Sin Guardar */}
        <AnimatePresence>
          {mostrarConfirmacion && (
            <motion.div
      ...
      {/* Modal de ConfirmaciÃ³n de Cambios ANTES de Guardar */}
