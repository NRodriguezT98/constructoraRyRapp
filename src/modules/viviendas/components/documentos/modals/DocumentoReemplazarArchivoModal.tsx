...
import { useReemplazarArchivoForm } from '@/modules/viviendas/hooks/documentos'
import type { DocumentoVivienda } from '@/modules/viviendas/types/documento-vivienda.types'
import { formatFileSize } from '@/modules/viviendas/types/documento-vivienda.types'
            ...
            <div className={styles.warning.container}>
              <div className={styles.warning.content}>
                ...
                <div className="flex-1">
                  <h3 className={styles.warning.title}>š ï¸ Advertencia Importante</h3>
                  <ul className={styles.warning.list}>
                    ...
                    <li>€¢ AcciÃ³n <strong>registrada en auditorÃ­a</strong></li>
                    <li>€¢ Solo para correcciÃ³n de errores administrativos</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Explica por qué© Estás reemplazando este archivo (mÃ­nimo 10 caracteres)..."
                />
                <p className={styles.form.helperText}>
                  {justificacion.length}/10 caracteres mÃ­nimos
                </p>
              </div>

              {/* Contraseña de confirmaciÃ³n */}
                    ...
                    (!nuevoArchivo || justificacion.length < 10 || !password) && (
                      <div className={styles.tooltip.container}>
                        ...
                        {nuevoArchivo && justificacion.length < 10 && (
                          <div>
                            €¢ JustificaciÃ³n debe tener mÃ­nimo 10 caracteres (
