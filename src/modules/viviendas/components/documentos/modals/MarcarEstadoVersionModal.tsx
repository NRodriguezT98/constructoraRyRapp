      ...
      >
        ...
        >
          ...
          <div className="p-6 space-y-4">
            ...
            {/* Motivo (solo para errÃ³nea y obsoleta) */}
            {accion !== 'restaurar' && (
              <div>
                <label
                  htmlFor="motivo"
                ...
                {config.motivosPredef.length > 0 && !motivoPersonalizado && (
                  <div className="space-y-2 mb-3">
                    ...
                    >
                      œï¸ Escribir motivo personalizado...
                    </button>
                  </div>
                )}
            ...
            {/* versión correcta (solo para errÃ³nea) */}
            ...
            {/* Alert de confirmaciÃ³n para restaurar */}
            {accion === 'restaurar' && (
