 ...
 *  Diseño tipo diff/comparaciÃ³n profesional
 *  visualización clara de antes/despuÃ©s
 */
...
import type { ResumenCambiosDocumento } from '@/modules/viviendas/hooks/documentos'
...
export function ConfirmarCambiosDocumentoModal({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      >
        {/* Header - Compacto */}
        <div className="relative bg-gradient-to-br from-orange-600 via-amber-600 to-yellow-600 px-4 py-3">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-xs text-green-50 flex items-center gap-1.5">
                  ...
                  <span>{cambios.totalCambios} modificaciÃ³n{cambios.totalCambios !== 1 ? 'es' : ''} detectada{cambios.totalCambios !== 1 ? 's' : ''}</span>
                </p>
              </div>
            </div>
            <button
          ...
          <div className="space-y-2.5">
            {cambios.cambios.map((cambio, index) => (
              ...
              >
                ...
                {/* ComparaciÃ³n Antes/DespuÃ©s - Compacto y Responsive */}
                <div className="p-3">
                  <div className="grid grid-cols-1 md:grid-cols-[1fr,auto,1fr] gap-2 md:gap-3 items-center">
                    ...
                    {/* FLECHA - Responsive (horizontal en mÃ³vil, vertical en desktop) */}
                    <div className="flex md:flex-col items-center justify-center">
                      <div className="p-1.5 rounded-full bg-gradient-to-br from-orange-500 to-emerald-600 shadow-md">
