...
import { formatFileSize, getFileExtension } from '@/modules/viviendas/types/documento-vivienda.types'
          ...
          <div className='relative flex-shrink-0' ref={menuRef}>
            ...
            <AnimatePresence>
              {menuAbierto && (
                ...
                {/* Nueva versión - disponible para todos */}
                <button
                  type="button"
                  onClick={(e) => {
                    e.preventDefault()
