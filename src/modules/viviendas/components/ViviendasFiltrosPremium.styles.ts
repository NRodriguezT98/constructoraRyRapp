...
export const viviendasFiltrosStyles = {
  ...
  container: 'sticky top-4 z-40 backdrop-blur-xl bg-white/90 dark:bg-gray-800/90 rounded-xl border border-gray-200/50 dark:border-gray-700/50 p-4 shadow-2xl shadow-orange-500/10',
  ...
  searchInput: 'w-full pl-10 pr-10 py-2.5 bg-gray-50 dark:bg-gray-900/50 border-2 border-gray-200 dark:border-gray-700 rounded-lg focus:border-orange-500 focus:ring-4 focus:ring-orange-500/20 transition-all text-sm placeholder:text-gray-400',
  ...
  // Selectores
  select: 'px-3 py-2.5 bg-gray-50 dark:bg-gray-900/50 border-2 border-gray-200 dark:border-gray-700 rounded-lg focus:border-orange-500 focus:ring-4 focus:ring-orange-500/20 transition-all text-sm min-w-[180px]',
