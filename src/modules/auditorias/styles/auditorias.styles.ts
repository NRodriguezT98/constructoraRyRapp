 ...
 * Color principal: Teal/Cyan/Sky
 *
 * Características:
 * - Glassmorphism con backdrop-blur-xl
 * - Gradientes vibrantes (teal→cyan→sky)
...
export const auditoriasStyles = {
  ...
  container: {
    page: 'min-h-screen bg-gradient-to-br from-slate-50 via-teal-50 to-cyan-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950',
  ...
  header: {
    container:
      'relative overflow-hidden rounded-3xl bg-gradient-to-br from-teal-600 via-cyan-600 to-sky-600 dark:from-teal-700 dark:via-cyan-700 dark:to-sky-800 p-8 shadow-2xl shadow-teal-500/20',
    pattern:
    ...
    iconCircle:
      'w-12 h-12 rounded-2xl bg-white/20 backdrop-blur-sm flex items-center justify-center',
    icon: 'w-7 h-7 text-white',
    titleWrapper: 'space-y-1',
    title: 'text-3xl font-bold text-white',
    subtitle: 'text-teal-100 dark:text-teal-200 text-sm',
    badge:
      'inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/20 backdrop-blur-md border border-white/30 text-white text-sm font-medium',
  },
  ...
  filtros: {
    container:
      'sticky top-4 z-40 backdrop-blur-xl bg-white/90 dark:bg-gray-800/90 rounded-2xl border border-gray-200/50 dark:border-gray-700/50 p-4 shadow-2xl shadow-teal-500/10',
    grid: 'grid grid-cols-1 md:grid-cols-3 gap-3',
    selectWrapper: 'relative',
    label:
      'block text-xs font-semibold text-gray-600 dark:text-gray-400 mb-1.5',
    select:
      'w-full px-3 py-2 bg-gray-50 dark:bg-gray-900/50 border-2 border-gray-200 dark:border-gray-700 rounded-xl focus:border-teal-500 focus:ring-4 focus:ring-teal-500/20 transition-all text-sm',
    footer:
    ...
    clearButton:
      'text-xs font-semibold text-teal-600 dark:text-teal-400 hover:text-teal-700 dark:hover:text-teal-300 transition-colors cursor-pointer',
  },

  // 📋 TABLA
  tabla: {
    container:
      'backdrop-blur-xl bg-white/80 dark:bg-gray-800/80 rounded-2xl border border-gray-200/50 dark:border-gray-700/50 overflow-hidden shadow-lg',
    wrapper: 'overflow-x-auto',
    table: 'w-full',
    thead:
      'bg-gray-50/80 dark:bg-gray-900/50 border-b border-gray-200 dark:border-gray-700',
  ...
  empty: {
    ...
    iconCircle:
      'w-24 h-24 rounded-3xl bg-gradient-to-br from-teal-500/10 to-cyan-500/10 flex items-center justify-center mx-auto',
    icon: 'w-12 h-12 text-teal-500 dark:text-teal-400',
    iconGlow: 'absolute inset-0 blur-3xl bg-teal-500/20 rounded-full',
    ...
    button:
      'inline-flex items-center gap-2 px-4 py-2 bg-teal-600 hover:bg-teal-700 text-white rounded-xl font-medium transition-colors shadow-lg shadow-teal-500/30',
  },
  ...
  loading: {
    ...
    filtrosSkeleton:
      'h-32 bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 dark:from-gray-700 dark:via-gray-600 dark:to-gray-700 rounded-2xl animate-pulse',
    tablaSkeleton:
      'h-96 bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 dark:from-gray-700 dark:via-gray-600 dark:to-gray-700 rounded-2xl animate-pulse',
  },
  ...
  modal: {
    ...
    closeButton:
      'w-8 h-8 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center justify-center transition-colors',
...
export const metricasIconColors = {
  totalEventos: {
    ...
    textGradient: 'from-teal-600 via-cyan-600 to-sky-600',
