      ...
      <div className={s.backdrop}>
        ...
        >
          ...
          <div className={s.header.container}>
            ...
            <button onClick={onClose} disabled={isPending} className={s.header.closeButton}>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className={s.form.container}>
            ...
            <div className={s.form.section}>
              ...
              <div className={s.input.container}>
                ...
                <textarea
                  ...
                  disabled={isPending}
                />
                {errors.descripcion && <p className={s.input.error}>{errors.descripcion.message}</p>}
              </div>
            </div>
            ...
            <div className={s.form.section}>
              ...
              <div className={s.grid.threeColumns}>
                <label className={s.checkbox.container}>
                  <input {...register('requiere_entidad')} type="checkbox" className={s.checkbox.field} disabled={isPending} />
                ...
                <label className={s.checkbox.container}>
                  <input {...register('permite_multiples_abonos')} type="checkbox" className={s.checkbox.field} disabled={isPending} />
                  <div className={s.checkbox.labelContainer}>
                ...
                <label className={s.checkbox.container}>
                  <input {...register('es_subsidio')} type="checkbox" className={s.checkbox.field} disabled={isPending} />
                  <div className={s.checkbox.labelContainer}>
            ...
            <div className={s.form.section}>
              ...
              <div className={s.grid.twoColumns}>
                <div className={s.input.container}>
                  ...
                  <select {...register('color')} className={s.input.field} disabled={isPending}>
                ...
                <div className={s.input.container}>
                  ...
                  <select {...register('icono')} className={s.input.field} disabled={isPending}>
                    ...
                    <option value="BadgeDollarSign">BadgeDollarSign (Insignia $)</option>
              ...
              <div className={s.input.container}>
                ...
                <input
                  ...
                  disabled={isPending}
                />
                {errors.orden && <p className={s.input.error}>{errors.orden.message}</p>}
              </div>

              <label className={s.checkbox.container}>
                <input {...register('activo')} type="checkbox" className={s.checkbox.fieldActive} disabled={isPending} />
                <div className={s.checkbox.labelContainer}>
                  <p className={s.checkbox.label}>Fuente Activa</p>
                  <p className={s.checkbox.description}>Disponible para usar en negociaciones</p>
                </div>
              </label>
            </div>
            ...
            <div className={s.actions.container}>
              <button type="button" onClick={onClose} disabled={isPending} className={s.actions.cancelButton}>
                Cancelar
              </button>
              <button type="submit" disabled={isPending || !isDirty} className={s.actions.submitButton}>
                {isPending ? (
                  <>
