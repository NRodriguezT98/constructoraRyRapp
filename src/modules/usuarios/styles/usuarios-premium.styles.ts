...
export const metricasUsuariosColors = {
  total: {
    ...
    textGradient:
      'from-violet-600 to-purple-700 dark:from-violet-400 dark:to-purple-500',
  },
  administradores: {
  ...
  bloqueados: {
    ...
    textGradient:
      'from-gray-600 to-slate-700 dark:from-gray-400 dark:to-slate-500',
  },
}
...
export const usuariosPremiumStyles = {
  ...
  header: {
    container:
      'relative overflow-visible rounded-3xl bg-gradient-to-br from-violet-600 via-purple-600 to-indigo-600 dark:from-violet-700 dark:via-purple-700 dark:to-indigo-800 p-8 shadow-2xl shadow-violet-500/20 mb-6 z-10',
    pattern:
    ...
    iconCircle:
      'w-12 h-12 rounded-2xl bg-white/20 backdrop-blur-sm flex items-center justify-center shadow-lg shadow-violet-500/30',
    icon: 'w-7 h-7 text-white',
    titleWrapper: 'space-y-1',
    title: 'text-3xl font-bold text-white',
    subtitle: 'text-violet-100 dark:text-violet-200 text-sm',
    badge:
      'inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/20 backdrop-blur-md border border-white/30 text-white text-sm font-medium shadow-lg',
  },
  ...
  fab: {
    ...
    buttonGlow:
      'absolute inset-0 bg-gradient-to-r from-violet-400 to-indigo-400 blur-xl opacity-50 group-hover:opacity-75 transition-opacity',
  ...
  filtros: {
    container:
      'sticky top-4 z-40 backdrop-blur-xl bg-white/90 dark:bg-gray-800/90 rounded-2xl border border-gray-200/50 dark:border-gray-700/50 p-5 shadow-2xl shadow-violet-500/10 mb-6',
    wrapper: 'flex flex-wrap items-center gap-3',

    // Input de búsqueda
    searchWrapper: 'relative flex-1 min-w-[250px]',
    searchIconLeft:
      'absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 dark:text-gray-500 pointer-events-none',
    searchInput:
      'w-full pl-11 pr-4 py-2.5 bg-gray-50 dark:bg-gray-900/50 border-2 border-gray-200 dark:border-gray-700 rounded-xl focus:border-violet-500 focus:ring-4 focus:ring-violet-500/20 transition-all text-sm placeholder:text-gray-400 dark:placeholder:text-gray-500',

    // Selects
    select:
      'px-4 py-2.5 bg-gray-50 dark:bg-gray-900/50 border-2 border-gray-200 dark:border-gray-700 rounded-xl focus:border-violet-500 focus:ring-4 focus:ring-violet-500/20 transition-all text-sm appearance-none cursor-pointer min-w-[140px]',

    // Botón limpiar
    clearButton:
      'px-4 py-2.5 text-sm font-semibold text-violet-600 dark:text-violet-400 hover:text-violet-700 dark:hover:text-violet-300 transition-colors',
    ...
    createButtonGlow:
      'absolute inset-0 bg-gradient-to-r from-violet-400 to-indigo-400 blur-lg opacity-30 group-hover:opacity-50 transition-opacity',
  ...
  tabla: {
    container:
      'backdrop-blur-xl bg-white/90 dark:bg-gray-800/90 rounded-2xl border border-gray-200/50 dark:border-gray-700/50 shadow-lg overflow-hidden',
    ...
    avatar:
      'flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br text-xs font-medium text-white shadow-lg',
    avatarInfo: 'min-w-0',
    ...
    // Acciones
    actionButton:
      'p-2 rounded-lg text-gray-600 dark:text-gray-400 hover:bg-violet-100 dark:hover:bg-violet-900/30 hover:text-violet-600 dark:hover:text-violet-400 transition-all',
  },

  // 🚫 EMPTY STATE
  empty: {
    wrapper:
      'flex flex-col items-center justify-center py-16 text-center backdrop-blur-xl bg-white/90 dark:bg-gray-800/90 rounded-2xl border border-gray-200/50 dark:border-gray-700/50',
  ...
  loading: {
    ...
    spinner:
      'h-8 w-8 animate-spin rounded-full border-4 border-gray-200 dark:border-gray-700 border-t-violet-600',
  },
}
