...
export const expedienteStyles = {
  // 🎯 PÁGINA
  page: {
    container: 'min-h-screen bg-gradient-to-br from-slate-50 via-red-50/30 to-rose-50/30 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950',
    content: 'max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-4',
    backLink: 'inline-flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 hover:text-red-600 dark:hover:text-red-400 transition-colors mb-2',
  },
  ...
  hero: {
    ...
    consecutivoBadge: 'inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white/20 backdrop-blur-md border border-white/30 text-white text-sm font-bold tracking-wide',
    estadoBadge: {
      pendiente: 'inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-yellow-400/90 text-yellow-900 text-xs font-bold shadow-lg',
      cerrada: 'inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-emerald-400/90 text-emerald-900 text-xs font-bold shadow-lg',
    },
  ...
  // ⏱️ TIMELINE
  timeline: {
    container: 'relative overflow-hidden rounded-xl backdrop-blur-xl bg-white/80 dark:bg-gray-800/80 border border-gray-200/50 dark:border-gray-700/50 p-5 shadow-lg',
    ...
    hitoIconCircle: 'w-10 h-10 rounded-full flex items-center justify-center shadow-md mb-2',
    ...
    hitoIcon: 'w-4 h-4',
    hitoLabel: 'text-xs font-medium text-gray-700 dark:text-gray-300 leading-tight',
    hitoFecha: 'text-[10px] text-gray-500 dark:text-gray-400 mt-0.5',
    connector: 'absolute top-5 left-[calc(50%+20px)] w-[calc(100%-40px)] h-0.5 bg-gradient-to-r from-red-300 to-rose-300 dark:from-red-700 dark:to-rose-700',
  },

  // � SNAPSHOT BANNER
  snapshotBanner: {
    container: 'flex items-start gap-3 px-4 py-3 rounded-xl bg-amber-50/80 dark:bg-amber-950/30 border border-amber-200/60 dark:border-amber-800/40 backdrop-blur-sm',
    iconCircle: 'flex-shrink-0 w-8 h-8 rounded-lg bg-amber-100 dark:bg-amber-900/50 flex items-center justify-center',
  ...
  // �📑 TABS
  tabs: {
    container: 'flex items-center gap-1 overflow-x-auto rounded-xl backdrop-blur-xl bg-white/80 dark:bg-gray-800/80 border border-gray-200/50 dark:border-gray-700/50 p-1.5 shadow-lg',
    ...
    tabInactive: 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700/50 hover:text-gray-900 dark:hover:text-gray-200',
    tabIcon: 'w-4 h-4',
    content: 'rounded-xl backdrop-blur-xl bg-white/80 dark:bg-gray-800/80 border border-gray-200/50 dark:border-gray-700/50 p-5 shadow-lg',
  },
  ...
  vivienda: {
    ...
    field: 'space-y-1',
    fieldLabel: 'text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider',
  ...
  financiero: {
    ...
    descuentoCard: 'rounded-xl border border-amber-200 dark:border-amber-800 bg-amber-50/50 dark:bg-amber-950/20 p-4',
    retencionCard: 'rounded-xl border border-red-200 dark:border-red-800 bg-red-50/50 dark:bg-red-950/20 p-4',
    devolucionCard: 'rounded-xl border-2 border-emerald-300 dark:border-emerald-700 bg-emerald-50/50 dark:bg-emerald-950/20 p-5',
    devolucionMonto: 'text-3xl font-black text-emerald-700 dark:text-emerald-400',
    docLink: 'inline-flex items-center gap-2 text-sm text-red-600 dark:text-red-400 hover:underline',
    sectionTitle: 'text-sm font-bold text-gray-700 dark:text-gray-300 mb-3 flex items-center gap-2',
  },
  ...
  fuentes: {
    ...
    tipoBadge: 'inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold',
    estadoBadge: 'inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[10px] font-bold bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400 border border-red-200 dark:border-red-800',
    progressBar: 'w-full h-2 rounded-full bg-gray-200 dark:bg-gray-700 overflow-hidden',
    progressFill: 'h-full rounded-full bg-gradient-to-r from-red-500 to-rose-500 transition-all',
  ...
  abonos: {
    ...
    badgeActivo: 'inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400',
    badgeAnulado: 'inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400',
    comprobante: 'inline-flex items-center gap-1 text-red-600 dark:text-red-400 hover:underline text-xs',
    resumen: 'mt-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/30 p-4',
    ...
    mobileCard: 'sm:hidden rounded-xl border border-gray-200 dark:border-gray-700 bg-white/50 dark:bg-gray-800/50 p-3 space-y-2',
  ...
  auditoria: {
    section: 'space-y-4',
    sectionTitle: 'text-sm font-bold text-gray-700 dark:text-gray-300 flex items-center gap-2',
    ...
    rowIcon: 'w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0',
    ...
    cascadeItem: 'flex items-center gap-3 py-2 px-3 rounded-lg bg-gray-50 dark:bg-gray-900/30',
    cascadeIcon: 'w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0',
  ...
  loading: {
    ...
    timelineSkeleton: 'h-24 rounded-xl bg-gray-200 dark:bg-gray-700 animate-pulse',
    tabsSkeleton: 'h-12 rounded-xl bg-gray-200 dark:bg-gray-700 animate-pulse',
    contentSkeleton: 'h-64 rounded-xl bg-gray-200 dark:bg-gray-700 animate-pulse',
  },

  // ❌ ERROR
  error: {
    container: 'flex flex-col items-center justify-center py-20 text-center',
    iconCircle: 'w-16 h-16 rounded-full bg-red-100 dark:bg-red-900/30 flex items-center justify-center mb-4',
    ...
    backButton: 'inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-red-600 to-rose-600 text-white text-sm font-medium hover:from-red-700 hover:to-rose-700 transition-all shadow-lg',
  },
} as const
