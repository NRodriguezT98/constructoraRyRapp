      ...
      <div className='relative'>
        <div className={styles.timeline.track}>
          {hitos.map((hito, idx) => {
            ...
            return (
              <div key={hito.label} className='flex flex-1 items-start'>
                ...
                >
                  ...
                  <div
                    className={`relative z-10 ${styles.timeline.hitoIconCircle} ${hito.completado ? styles.timeline.hitoIconActive : styles.timeline.hitoIconPending}`}
                  >
                  ...
                  <p className={styles.timeline.hitoFecha}>
                    {formatDateCompact(hito.fecha)}
                  </p>
                </motion.div>
              </div>
            )
