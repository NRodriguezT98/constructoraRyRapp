  ...
  if (fuentes.length === 0) {
    return (
      <div className='py-10 text-center text-gray-400 dark:text-gray-500'>
        ...
        <p className='text-sm'>
          No hay fuentes de pago registradas en la snapshot
        </p>
      </div>
    )
  }
        ...
        return (
          <div key={`${fuente.tipo}-${idx}`} className={styles.fuentes.card}>
            ...
            <div className={styles.fuentes.cardHeader}>
              <span
                className={`${styles.fuentes.tipoBadge} ${colorConfig.bg} ${colorConfig.text}`}
              >
            ...
            <div className={styles.fuentes.progressBar}>
              <div
                className={styles.fuentes.progressFill}
            ...
            <div className='mt-3 space-y-1.5'>
              <div className={styles.fuentes.montoRow}>
                ...
                <span className={styles.fuentes.montoValue}>
                  {formatCOP(fuente.monto_aprobado)}
                </span>
              </div>
              <div className={styles.fuentes.montoRow}>
                <span className={styles.fuentes.montoLabel}>Recibido</span>
                <span className={styles.fuentes.montoValue}>
                  {formatCOP(fuente.monto_recibido)}
                </span>
              </div>
              <div className={styles.fuentes.montoRow}>
